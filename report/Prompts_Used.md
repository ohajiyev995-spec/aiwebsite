  ...
  window.TITANS_FALLBACK = () => ([
    {
      ...
      shifters:['Eren Yeager','Grisha Yeager','Eren Kruger'],
      abilities:['Fighting spirit'], weaknesses:[], firstAppearance:'S1',
      affiliations:['Various'], image:'assets/img/attack.svg',
      summary:'Balanced fighter known for relentless drive.', funFact:'—', spoilerLevel:'low' },
    { slug:'colossal', name:'Colossal Titan', heightMeters:60, type:'Colossal', category:'Nine',
      shifters:['Bertholdt Hoover','Armin Arlert'],
      abilities:['Steam','Explosive transform'], weaknesses:['Slow'], firstAppearance:'S1E1',
      affiliations:['Various'], image:'assets/img/colossal.svg',
      summary:'Catastrophic steam and explosive entry.', funFact:'—', spoilerLevel:'low' },
    { slug:'armored', name:'Armored Titan', heightMeters:15, type:'Armored', category:'Nine',
      shifters:['Reiner Braun'],
      abilities:['Armor plates'], weaknesses:['Joints exposed'], firstAppearance:'S1',
      affiliations:['Various'], image:'assets/img/armored.svg',
      summary:'Heavily plated for assault/defense.', funFact:'—', spoilerLevel:'low' }
  ]);
...
Checklist:
- Pages exist and match spec
- Internal links work
- Responsive layout at 360/768/1024/1440
- Modal and keyboard interactions validated
- JSON fallback tested / no console errors
